...
{	  	
	...
	public synchronized void setListener(AudioListener newListener) {
	...
	public Player(InputStream stream, AudioDevice device) throws JavaLayerException {
		this(stream, device, null);
	}


	public Player(InputStream stream, AudioDevice device, AudioListener listener) throws JavaLayerException
	{
	...
	{		
		try
		{
			...
			if (listener != null) {
				listener.GotSamples(output.getBuffer(), output.getBufferLength());
			}
